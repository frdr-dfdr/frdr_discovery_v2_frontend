...
module Geoblacklight
  ...
  require 'lunaris/view_helper_override'
  ...
  def self.inject!
    ...
    CatalogController.send(:include, Lunaris::ViewHelperOverride)
    CatalogController.send(:helper, Lunaris::ViewHelperOverride) unless
      CatalogController.helpers.is_a?(Lunaris::ViewHelperOverride)
